...
parser.add_argument('-gc', '--grad_clipping', type=float, default=10.0)
parser.add_argument('-lr', '--learning_rate', type=float, default=0.01)
parser.add_argument('-ds', '--decay_step', type=int, default=500)
parser.add_argument('-wd', '--weight_decay', type=float, default=0.0, help="weight decay for Adamax")
